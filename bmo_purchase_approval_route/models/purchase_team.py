...
class PurchaseTeamApprover(models.Model):
    ...
    team_id = fields.Many2one(
        comodel_name='purchase.team', string='Team', required=True, ondelete='cascade')
    user_id = fields.Many2one(
...
class PurchaseOrderApprover(models.Model):
    ...
    team_approver_id = fields.Many2one(
        comodel_name='purchase.team.approver', string='PO Team Approver', ondelete='set null')
    order_id = fields.Many2one(
        comodel_name='purchase.order', string='Order', required=True, ondelete='cascade')
