...
class InventorySelection(models.TransientModel):
    ...
    _description = "Stock Inventory Selection"
    ...
    def set_product_qty(self):
        ...
        return {
            ...
            'view_mode': 'form',
            'view_type': 'form',
            'view_id': self.env.ref("bmo_inventory_stock_adjustments.inventory_selection_form_view").id,
...
class InventorySelectionLine(models.TransientModel):
    ...
    _description = "Stock Inventory Line Selection Line"
